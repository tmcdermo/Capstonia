namespace Capstonia.Interfaces
{
    public interface IActor
    {
        ...
        //float Constitution { get; set; } // every point above 10 gives a health bonus
        //float Dexterity { get; set; } // every point above 10 gives a dodge bonus
        ...
        //float Strength { get; set; } // every point above 10 gives a dmg bonus 
    }
}